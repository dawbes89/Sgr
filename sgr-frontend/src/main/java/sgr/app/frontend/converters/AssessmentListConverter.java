...
public class AssessmentListConverter extends AbstractConverter<Long>
{
   ...
   protected String convertToString(Object object, UIComponent component)
   {
      ...
      final SchoolSubject findSchoolSubject = (SchoolSubject) component.getAttributes().get(
            SCHOOL_SUBJECT_ATTRIBUTE);
      ...
      String assessmentsWithTypes = assessment.stream().map(a -> convertAssessment(a)).collect(Collectors.joining(", "));
   ...
   private String convertAssessment(Assessment assessment)
   {
      ...
      return String
            .format("%s %s", convertToString, String.valueOf(translate).charAt(0));
   }
